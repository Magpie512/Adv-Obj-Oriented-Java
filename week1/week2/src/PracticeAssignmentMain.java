...
public class PracticeAssignmentMain {
    ...
    public static void main(String[] args) {
        ...
        Car car = new Car ("Toyota", "Corolla", 50, 4);
        //Create a Motorcycle with parameters "Harley-Davidson", "Iron 883", 15, false
        Motorcycle motorcycle = new Motorcycle ("Harley-Davidson", "Iron 883", 15, false);
        //Create a Truck with parameters "Volvo", "FH16", 200, 20
        Truck truck = new Truck ("Volvo", "FH16", 200, 20);
        Vehicle[] fleet = {car, motorcycle, truck}; // Loop through all vehicles
        for (Vehicle v : fleet) {
